...
angular.module('app')
.controller('RollcallCtrl',function($scope, $http, $stateParams, $ionicPopup) {
  var self = this;
  var eventId = $stateParams.eventId;

  var url_attendees = "http://localhost:9000/api/events/getAttendees/";
  var url_checkInOut = "http://localhost:9000/api/events/checkInOut/";
  var url_rule = "http://localhost:9000/api/rules/"
