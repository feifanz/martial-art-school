...
angular.module('app')
.controller('NotificationCtrl', function($scope, $http, $state, Auth) {
    var self = this;
    var url_messages = "http://localhost:9000/api/messages";
    var url_exceptAccess = "http://localhost:9000/api/messages/findAllExceptAccess/";
    var url_updateViewer = "http://localhost:9000/api/messages/updateViewers/";
    var url_getViewer = "http://localhost:9000/api/messages/getViewers/";
